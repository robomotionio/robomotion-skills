...
tags: ["churn-prevention", "churn", "prevention", "growth"]
...
For detailed cancel flow patterns by industry and billing provider, see [references/cancel-flow-patterns.md](${SKILL_DIR}/references/cancel-flow-patterns.md).
...
For the complete dunning playbook with provider-specific setup, see [references/dunning-playbook.md](${SKILL_DIR}/references/dunning-playbook.md).
