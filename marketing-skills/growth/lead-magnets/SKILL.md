---
name: lead-magnets
tags: ["lead-magnets", "lead", "magnets", "growth"]
...
**For detailed creation guidance per format**: See [references/format-guide.md](${SKILL_DIR}/references/format-guide.md)
...
**For detailed benchmarks by format and industry**: See [references/benchmarks.md](${SKILL_DIR}/references/benchmarks.md)
