---
name: co-marketing
tags: ["co-marketing", "marketing", "growth"]
...
For implementation, see the [tools registry](${SHARED_DIR}/references/USING-CLIS.md). Key tools for co-marketing:

| Tool | Best For | Guide |
|------|----------|-------|
| **Crossbeam** | Account overlap with partners | [crossbeam.md](${SHARED_DIR}/references/crossbeam.md) |
| **Introw** | Partner program management, deal registration | [introw.md](${SHARED_DIR}/references/introw.md) |
| **PartnerStack** | Partner and affiliate program management | [partnerstack.md](${SHARED_DIR}/references/partnerstack.md) |
