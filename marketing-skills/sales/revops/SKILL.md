...
**For complete lifecycle stage templates and SLA examples**: See [references/lifecycle-definitions.md](${SKILL_DIR}/references/lifecycle-definitions.md)
...
**For detailed scoring templates and example models**: See [references/scoring-models.md](${SKILL_DIR}/references/scoring-models.md)
...
**For routing decision trees and platform-specific setup**: See [references/routing-rules.md](${SKILL_DIR}/references/routing-rules.md)
...
**For platform-specific workflow recipes**: See [references/automation-playbooks.md](${SKILL_DIR}/references/automation-playbooks.md)
...
For implementation, see the [tools registry](${SHARED_DIR}/references/USING-CLIS.md). Key RevOps tools:

| Tool | What It Does | Guide |
|------|-------------|-------|
| **HubSpot** | CRM, marketing automation, lead scoring, workflows | [hubspot.md](${SHARED_DIR}/references/hubspot.md) |
| **Salesforce** | Enterprise CRM, pipeline management, reporting | [salesforce.md](${SHARED_DIR}/references/salesforce.md) |
| **Calendly** | Meeting scheduling, round-robin routing | [calendly.md](${SHARED_DIR}/references/calendly.md) |
| **SavvyCal** | Scheduling with priority-based availability | [savvycal.md](${SHARED_DIR}/references/savvycal.md) |
| **Clearbit** | Real-time lead enrichment and scoring | [clearbit.md](${SHARED_DIR}/references/clearbit.md) |
| **Apollo** | Contact data, enrichment, and outbound sequences | [apollo.md](${SHARED_DIR}/references/apollo.md) |
| **ActiveCampaign** | Marketing automation for SMBs, lead scoring | [activecampaign.md](${SHARED_DIR}/references/activecampaign.md) |
| **Zapier** | Cross-tool automation and workflow glue | [zapier.md](${SHARED_DIR}/references/zapier.md) |
| **Introw** | Partner-sourced pipeline, commissions, deal registration, QBRs | [introw.md](${SHARED_DIR}/references/introw.md) |
| **Crossbeam** | Partner account overlaps and co-sell identification | [crossbeam.md](${SHARED_DIR}/references/crossbeam.md) |
...
Adapted from [marketingskills](https://github.com/coreyhaines31/marketingskills) by Corey Haines (MIT).
