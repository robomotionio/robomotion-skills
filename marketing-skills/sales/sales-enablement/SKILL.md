...
tags: ["sales-enablement", "sales", "enablement"]
...
**For full slide-by-slide guidance**: See [references/deck-frameworks.md](${SKILL_DIR}/references/deck-frameworks.md)
...
**For templates by use case**: See [references/one-pager-templates.md](${SKILL_DIR}/references/one-pager-templates.md)
...
**For the full objection library**: See [references/objection-library.md](${SKILL_DIR}/references/objection-library.md)
...
**For full script templates**: See [references/demo-scripts.md](${SKILL_DIR}/references/demo-scripts.md)
...
For partner sales enablement, see the [tools registry](${SHARED_DIR}/references/USING-CLIS.md):

| Tool | What It Does | Guide |
|------|-------------|-------|
| **Introw** | Partner engagement tracking, deal registration, mutual action plans | [introw.md](${SHARED_DIR}/references/introw.md) |
