...
**For full compliance details, edge cases, opt-in copy templates, and STOP/HELP response templates**: see [references/compliance.md](${SKILL_DIR}/references/compliance.md).
...
**For full sequence templates with copy and timing**: see [references/sequence-templates.md](${SKILL_DIR}/references/sequence-templates.md).
...
**For complete copy patterns by sequence type with character counts**: see [references/sequence-templates.md](${SKILL_DIR}/references/sequence-templates.md).
...
**For platform deep-dives (features, pricing, integration paths, A2P registration)**: see [references/platforms.md](${SKILL_DIR}/references/platforms.md).
...
For implementation, see the [tools registry](${SHARED_DIR}/references/USING-CLIS.md). Key SMS tools:

| Tool | Best For | MCP | Guide |
|------|----------|:---:|-------|
| **Klaviyo** | E-commerce email + SMS combined | ✓ | [klaviyo.md](${SHARED_DIR}/references/klaviyo.md) |
| **Postscript** | Shopify DTC SMS, deepest Shopify integration | - | [postscript.md](${SHARED_DIR}/references/postscript.md) |
| **Attentive** | Mid-market+ DTC SMS, full-service | - | [attentive.md](${SHARED_DIR}/references/attentive.md) |
| **Twilio** | Raw API for custom builds, transactional, dev-first | - | [twilio.md](${SHARED_DIR}/references/twilio.md) |
| **Plivo** | Twilio alternative, lower per-send cost | - | [plivo.md](${SHARED_DIR}/references/plivo.md) |
| **AudienceTap** | AI-forward DTC, on-pack QR opt-in | - | [audiencetap.md](${SHARED_DIR}/references/audiencetap.md) |
| **Brevo** | EU email + SMS, SMB-friendly | ✓ | [brevo.md](${SHARED_DIR}/references/brevo.md) |
| **Customer.io** | Behavior-based SMS automation | - | [customer-io.md](${SHARED_DIR}/references/customer-io.md) |
