...
**For detailed prompting guides**: See [references/ai-video-prompting.md](${SKILL_DIR}/references/ai-video-prompting.md)
...
| Tool | Type | MCP | Guide |
|------|------|:---:|-------|
| **HeyGen** | AI avatars | Yes | [heygen.md](${SHARED_DIR}/references/heygen.md) |
| **Hyperframes** | Programmatic video | - | [hyperframes.md](${SHARED_DIR}/references/hyperframes.md) |
