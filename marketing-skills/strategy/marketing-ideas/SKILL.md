...
tags: ["marketing-ideas", "marketing", "ideas", "strategy"]
...
**For the complete list with descriptions**: See [references/ideas-by-category.md](${SKILL_DIR}/references/ideas-by-category.md)
